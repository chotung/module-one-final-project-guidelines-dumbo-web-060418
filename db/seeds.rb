...
Monster.create(name: "Ogre", strength: 18, dexterity: 8, constitution: 16, hit_dice: 4, armor_value: 3, main_hand: Weapon.find_by(id: 8).name, exp_value: 14)
...
Monster.create(name: "Bugbear", strength: 16, dexterity: 8, constitution: 16, hit_dice: 3, armor_value: 2, main_hand: Weapon.find_by(id: 8).name, exp_value: 9)
